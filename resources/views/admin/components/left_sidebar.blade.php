<aside class="sidebar" id="sidebar">
    ...
    <div style="overflow-y:auto; flex:1; padding-bottom:10px;">
        ...
        <nav class="nav flex-column px-0" style="gap:2px;">
            ...
            <a class="nav-link {{ request()->is('admin/cashiers*') ? 'active' : '' }}" href="{{ url('/admin/cashiers') }}">
            ...
            <a class="nav-link {{ request()->is('admin/debtors*') ? 'active' : '' }}" href="{{ url('/admin/debtors') }}">
                <i class="bi bi-people nav-icon"></i>
                <span>Debtors</span>
            </a>
            ...
            <a class="nav-link {{ request()->is('admin/inventory*') ? 'active' : '' }}" href="{{ url('/admin/inventory') }}">
