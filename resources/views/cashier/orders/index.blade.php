...
<body class="pos-page">
    ...
    <nav class="top-nav">
        ...
        <div class="collapse d-lg-flex top-nav-menu flex-grow-1 ms-lg-3" id="topNavMenu">
            <div class="nav-menu-inner d-flex w-100 gap-2">
                ...
                <a href="#" class="nav-pill active"><i class="bi bi-list-ul"></i> Orders</a>
        ...
        <div class="orders-container">
            ...
            @else
                @foreach ($orders as $order)
                    @include('cashier.orders.order_card_completed', ['order' => $order])
                @endforeach
            @endif
        </div>
    </div>
    ...
    <script>
        ...
        btnConfirmReturn.addEventListener('click', function() {
            ...
            fetch('{{ route('cashier.orders.process_return') }}', {
                    method: 'POST',
                    headers: {
