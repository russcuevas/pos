...
class CashierPendingOrdersController extends Controller
{
    ...
    public function FetchOrderCard($orderNumber = null)
    {
        ...
        $html = view('cashier.pending_orders.order_card_partial', ['order' => $order])->render();
    ...
    public function SendChat(Request $request)
    {
        ...
        $chat = \App\Models\OrdersChats::create([
            'order_id' => $order->id,
            'customer_id' => null, // Cashier message
            'message' => $message,
            'allowed' => \Illuminate\Support\Facades\Auth::guard('cashier')->id()
        ]);
    ...
    {
        $orderNumber = $request->input('order_number');
        $cashierId = \Illuminate\Support\Facades\Auth::guard('cashier')->id();
